<template>
  <div class="q-pa-md q-gutter-md">
    ...
    <div class="row justify-center">
      <q-img src="statics/img/material.png" id="target-img-1" style="height: 100px">
        <div class="absolute-bottom-right" style="border-top-left-radius: 5px">#target-img-11</div>
      </q-img>
      <q-img src="statics/img/parallax2.jpg" id="target-img-2" style="height: 100px">
        <div class="absolute-bottom-right" style="border-top-left-radius: 5px">#target-img-2</div>
      </q-img>
      <q-img src="statics/img/blueish.jpg" style="height: 100px">
